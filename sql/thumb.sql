...
create table `education_experience`(
 ...
 `schiool_name` varchar(32) not null comment '学校',
 `major` varchar(32) not null comment '专业',
 `degree` varchar(16) not null comment '学位',
 `comment` varchar(512) not null comment '备注',
 `start_date` int comment '开始日期',
 `end_date` int comment '结束日期',
 `create_time` timestamp not null default current_timestamp comment '创建时间',
 `update_time` timestamp not null default current_timestamp on update current_time comment '修改时间',
 primary key (`id`)
) comment '教育经历';
...
create table `work_experience`(
 `id` int not null auto_increment,
 `user_id` varchar(32) not null comment '用户id',
 `compnay_name` varchar(32) not null comment '公司名称',
 `position` varchar(32) not null comment '职位',
 `comment` varchar(512) not null comment '备注',
 `start_date` int comment '开始时间',
 `end_data` int comment `结束时间`,
 `create_time` timestamp not null default current_timestamp comment '创建时间',
 `update_time` timestamp not null default current_timestamp on update current_time comment '修改时间',
 primary key(`id`)
) comment '工作经验';
...
create table `project_info`(
 ...
 `project_avatar` varchar(512) default null commet '项目封面',
 `project_difficulty` float default '0' comment '项目难度',
 `category_type` int(2) not null comment '项目类型类目编号',
 `category_name` varchar(64) not null comment '项目类型类目名称',
 `project_progress` int(2) default '0' comment '项目进度',
 `project_status` int default '0' commnent '项目状态，0进行中,1成功，2失败',
 ...
 `project_start_time` int comment '项目开始时间',
 `project_end_time` int comment '项目结束时间',
 `create_time` timestamp not null default current_timestamp comment '创建时间',
 `update_time` timestamp not null default current_timestamp on update current_time comment '修改时间',
...
create table `project_number`(
 `id` int nou null auto_increment,
 `project_id` varchar(32) not null,
 `project_name` varchar(64) default '' comment '项目名称',
 `project_avatar` varchar(512) default null commet '项目封面',
 `user_role` tinyint(1) default '0' comment '角色0未知',
 ...
 `user_avator` varchar(512) default '' comment '用户头像',
...
create table `project_picture`(
 ...
 `picture_url` varchar(512) defalut null comment '图片地址',
 `create_time` timestamp not null default current_timestamp comment '创建时间',
 `update_time` timestamp not null default current_timestamp on update current_time comment '修改时间',
...
create table `team_apply`(
 ...
 `applicants_experience` tinyint(2) default '0' comment '申请者工作经验，0:在校学生， 1:0年 2:1-2年 3:3-5年 4:5-10年 5:10年+'
 `applicants_role` tinyint(1) default '0' comment '申请的角色，可以与用户本来的角色不同',
 `workday_start_time` int comment '工作日空闲开始时间',
 `workday_end_time` int comment '工作日空闲结束时间',
 `weekend_start_time` int comment '周末空闲开始时间',
 `weekend_end_time` int comment '周末空闲结束时间',
 `commnets` varchar(512) comment '申请备注',
...
create table `user_like`(
 ...
 `status` tinyint(1) default '1' comment '点赞状态，0取消1点赞',
 `create_time` timestamp not null default current_timestamp comment '创建时间',
 `update_time` timestamp not null default current_timestamp on update current_time comment '修改时间',
 primary key(`id`),
